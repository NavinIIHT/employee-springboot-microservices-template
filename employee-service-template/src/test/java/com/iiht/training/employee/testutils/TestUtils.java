...
public class TestUtils {
	...
	static {
		...
		xmlFile.delete();
		removeLineFromFile("../output_revised.txt", "employee");
		removeLineFromFile("../output_boundary_revised.txt", "employee");
		removeLineFromFile("../output_exception_revised.txt", "employee");
