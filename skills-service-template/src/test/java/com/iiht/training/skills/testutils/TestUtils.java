...
public class TestUtils {
	...
	static {
		...
		xmlFile.delete();
		removeLineFromFile("../output_revised.txt", "skills");
		removeLineFromFile("../output_boundary_revised.txt", "skills");
		removeLineFromFile("../output_exception_revised.txt", "skills");
